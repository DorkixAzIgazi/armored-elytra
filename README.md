...
**Since 1.21.2 Mojang changed how equipment is rendered. Players not having the mod installed on the client will see a missing texture on the elytra if the armor has armor trims, but the item still functions if the mod is only installed on the server.**
